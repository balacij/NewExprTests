...
import KnowledgeBase.Chunk (Chunk, mkChunk, unChunk, chunkType, HasChunkRefs (chunkRefs))
import KnowledgeBase.UID (UID, HasUID(..))

import qualified Data.Map as M
import Data.List (nub, (\\))
import Data.Maybe (fromMaybe, mapMaybe, isJust)
import Data.Typeable (Typeable, Proxy(Proxy), typeOf, typeRep, TypeRep)
